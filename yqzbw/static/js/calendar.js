...
function HS_calender(){
	...
	style +=".calender { width:200px; height:auto; font-size:12px; margin-left:-90px;margin-top:-170px;background-color:#EDF5FF; no-repeat right center #fff; border:1px solid #397EAE; padding:1px}";
